...
from openrmm.security.api_keys import KEY_PREFIX, ApiKeyPrincipal
from openrmm.security.sync_tokens import TOKEN_PREFIX, verify
...
async def sync_principal(
    ...
    if not authorization or not authorization.lower().startswith("bearer "):
        raise HTTPException(
            ...
            "Not authenticated. Present a sync token: Authorization: Bearer orst_...",
