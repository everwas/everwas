...
from everwas.models.script import Script, ScriptSchedule
from everwas.natsio.agent_request import request_agent
from everwas.services.jobs import TargetError, device_matches_target, validate_target

log = structlog.get_logger()

# uuid5(NAMESPACE_DNS, "schedule.everwas.invalid"). Part of the wire contract:
