...
from everwas.models.job_outbox import KIND_SCRIPT_RUN, JobOutbox, JobOutboxStatus
from everwas.models.script import RunStatus, RunTrigger, Script, ScriptRun
    ...
    *,
    ...
    if len(devices) > ceiling:
        raise TooManyTargets(
            ...
            "EVERWAS_MAX_RUN_TARGETS if you mean it"
        )
    return devices
