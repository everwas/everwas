...
from everwas.models.facts import (
    FACT_TABLES,
    FactHardware,
    FactNetwork,
    FactPatchState,
...
from everwas.models.patch import PatchApproval, PatchCatalog
from everwas.schemas.sync import (
    SyncChangeOut,
    SyncDeviceOut,
    SyncInterfaceOut,
    SyncOrgOut,
...
from everwas.security.tenancy import scope_to_org
...
async def site_page(
    ...
    *,
    ...
    from everwas.models.device import Site
