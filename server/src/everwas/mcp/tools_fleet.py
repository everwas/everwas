...
from everwas.bitemporal.query import diff_facts, get_facts
...
from everwas.models.telemetry import DeviceStatusLatest
from everwas.services.patching import approved_external_ids
