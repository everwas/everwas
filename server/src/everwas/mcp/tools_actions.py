...
from everwas.mcp.context import (
    get_nats_connection,
    iso,
    parse_uuid,
    tool_call,
)
from everwas.models.alert import Alert, AlertRule, AlertState
from everwas.models.device import Device
from everwas.models.patch import ApprovalDecision, PatchApproval, PatchCatalog
from everwas.models.script import RunTrigger, Script
from everwas.services.jobs import TargetError, queue_script_run, resolve_targets
...
async def run_script(
    script_name: Annotated[
        str, Field(description="Exact name of a script in the Everwas library.")
    ],
    ...
    Scripts are referenced by name, the same name a human sees in the Everwas
