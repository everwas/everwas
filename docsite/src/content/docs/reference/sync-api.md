---
title: Sync API
description: The read-only, bearer-token surface external systems of record use to sweep the fleet — pagination contract, bitemporal parameters, and the incremental change feed.
---

:::note
The canonical contract is `docs/sync-api.md` in the repository; this page
