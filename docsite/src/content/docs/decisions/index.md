...
The source of truth is `docs/adr/` in the repository; these pages mirror
it. A record's status is one of **proposed**, **accepted**, or
**superseded**, and records are never edited to pretend history went
differently; a reversed decision gets a new record superseding the old.
